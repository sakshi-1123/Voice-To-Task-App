...
| :---: | :---: |
| ![Home Screen](./assets/screenshots/home_screen.png) | ![Task List Screen](./assets/screenshots/task_list.png) |
...
│   ├── notificationService.js  # System notification scheduler & date parser
